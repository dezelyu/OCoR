...
/*!
  ...
  resources.
*/
class OPENMAYARENDER_EXPORT OPENMAYA_DEPRECATED(<2016, "Use the DirectX 11 device from MHWRender::MRenderer::GPUDeviceHandle() instead.") MD3D9Renderer /* public MPxHardwareRender */ {
