...
public:
	...
	//
	OPENMAYA_DEPRECATED(2016, "Use the version MPxHwShaderNode::geometry() with the faceIDs argument instead.")
	...
	OPENMAYA_DEPRECATED(2016, "Use the version MPxHwShaderNode::glGeometry() with the faceIDs argument instead.")
...
BEGIN_NO_SCRIPT_SUPPORT:
	...
	//
	OPENMAYA_DEPRECATED(<2016, "Use renderImage() that provides RenderParameters instead.")
