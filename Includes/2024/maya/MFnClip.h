...
public:
	...
	OPENMAYA_DEPRECATED(<2016, "Use the method MFnClip::getPostCycle instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use the method MFnClip::getAbsoluteChannelSettings instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use the method MFnClip::setPostCycle instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use the method MFnClip::setAbsoluteChannelSettings instead.")
