...
/*!
	...
	<ul>
		<li>OPENMAYA_DEPRECATION_DISABLE_WARNING		: Silence deprecation warnings</li>
	</ul>
...
// SWIG and DOXYGEN does not support macro and attributes well enough, force them to ignore this
		...
		//	#endif
			...
			#define _OPENMAYA_POP_WARNING _OPENMAYA_DEPRECATION_ENABLE_WARNING
		#endif
...
## To treat deprecation as an error, use the following compiler switch:
