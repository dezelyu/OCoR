...
public:
	...
	OPENMAYA_DEPRECATED(2019, "Use the Viewport 2.0 device independent MHWRender interfaces instead.")
	static MHardwareRenderer*	theRenderer();

	OPENMAYA_DEPRECATED(2019, "Use the Viewport 2.0 backend independent MHWRender interfaces instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use MHWRender::MRenderOverride instead.")
	...
	OPENMAYA_DEPRECATED(2019, "Use MHWRender::MRenderTarget and MHWRender::MRenderTargetDescription instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use MHWRender::MRenderTarget and MHWRender::MRenderTargetDescription instead.")
	...
	OPENMAYA_DEPRECATED(<2016, "Use the Viewport 2.0 device independent MHWRender interfaces instead.")
	...
	OPENMAYA_DEPRECATED(2019, "Use MHWRender::MGeometryUtilities::acquireReferenceGeometry() instead.")
	...
	OPENMAYA_DEPRECATED(2019, "Use MHWRender::MGeometryUtilities::releaseReferenceGeometry() instead.")
